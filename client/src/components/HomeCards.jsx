        ...
        <li>
          <div className="homecards">
            ...
            <div className="homecards-text">
              ...
              <p>Encuentra tu lugar con una experiencia fotográfica inmersiva y la mayoría de los listados, incluidas cosas que no encontrarás en ningún otro lugar.</p>
      ...
      <li>
          <div className="homecards">
            ...
            <div className="homecards-text">
              ...
              <p>Estamos creando una experiencia en línea perfecta, desde comprar en la red de alquiler más grande hasta solicitar y pagar el alquiler.</p>
      ...
      <li>
          <div className="homecards">
            ...
            <div className="homecards-text">
              ...
              <p>No importa qué camino tome para vender su casa, podemos ayudarlo a lograr una venta exitosa.</p>
